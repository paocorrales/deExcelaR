...
* `include = FALSE` corre el código pero oculta tanto el código como los resultados. Es útil para usar en chunks de configuración general. 
...
Generalmente tiene sentido poner esto en el primer chunk de un documento, que como suele ser cuestiones de setup del reporte, también conviene ponerle `include = FALSE`.
